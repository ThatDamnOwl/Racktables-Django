DROP FUNCTION IF EXISTS racktables_django.033_api_filelinkipv4rspool_pull;

DELIMITER $$
CREATE FUNCTION racktables_django.033_api_filelinkipv4rspool_pull (ignored BIGINT)
RETURNS INT
NOT DETERMINISTIC
BEGIN
